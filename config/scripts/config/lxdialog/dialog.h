...
int first_alpha ( char *string,  char *exempt);
int dialog_yesno ( char *title,  char *prompt, int height, int width);
int dialog_msgbox ( char *title,  char *prompt, int height,
		int width, int pause);
int dialog_textbox ( char *title,  char *file, int height, int width);
int dialog_menu ( char *title,  char *prompt, int height, int width,
		int menu_height,  char *choice, int item_no, 
		struct dialog_list_item ** items);
int dialog_checklist ( char *title,  char *prompt, int height,
		int width, int list_height, int item_no,
		struct dialog_list_item ** items, int flag);
extern unsigned char dialog_input_result[];
int dialog_inputbox ( char *title,  char *prompt, int height,
		int width,  char *init);

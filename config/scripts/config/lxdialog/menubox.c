 ...
 */
static void
print_item (WINDOW * win,  char *item, int choice, int selected, int hotkey)
{
    int j;
 ...
 */
int
dialog_menu ( char *title,  char *prompt, int height, int width,
		int menu_height,  char *current, int item_no,

...
#include "lkc.h"
 ...
 char conf_def_filename[] = "config/.config";

 char conf_defname[] = "config/defconfig";
...
static char *conf_expand_value( char *in)
{
	struct symbol *sym;
	 char *src;
